                        ...
                        <div className="aspect-video w-full">
                            {loading ? (
                                <div className="w-full h-full flex items-center justify-center bg-retro-black">
                                    <span className="font-mono text-white/50 text-sm animate-pulse">{t('loading')}</span>
                                </div>
                            ) : videoId && iframeReady ? (
                                <iframe
                                ...
                                <div className="w-full h-full relative bg-retro-black">
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <span className="font-mono text-white/50 text-sm animate-pulse">{t('loadingPlayer')}</span>
                                    </div>
                                </div>
                            ) : (
                                <div className="w-full h-full flex items-center justify-center bg-retro-black">
                                    <p className="font-mono text-white/50 text-sm">{t('noVideo')}</p>
                                </div>
                            )}
                        </div>
                    </div>
                ...
                >
                    ...
                    >
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <path d="m9.545 15.568 6.273-3.568-6.273-3.568v7.136Z" fill="#0a0a0a" />
                        </svg>
                        {t('visitChannel')}
                    </a>
                </motion.div>
