...
/* ── Thumbnail Card — opens video in new tab ── */
function VideoCard({
  video,
  index,
  isInView,
      ...
      <div className="site-container">
        ...
        {loading ? (
          <div className="flex items-center justify-center py-20">
            <span className="font-mono text-retro-chrome/50 text-sm animate-pulse">
              {t("loading")}
            </span>
          </div>
        ) : (
