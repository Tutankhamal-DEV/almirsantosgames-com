            ...
            <div className="glow-card" style={{ height: '100%' }}>
                ...
                >
                    ...
                    <RetroButton
                        ...
                        icon={ctaIcon}
                        label={cta}
                        trailing={<ExternalLink size={14} color="#fff" style={{ opacity: 0.6 }} />}
...
function PixCopyCard({ delay, isInView }: { delay: number; isInView: boolean }) {
            ...
            <div className="glow-card" style={{ height: '100%' }}>
                ...
                >
                    ...
                    <p
                        ...
                        style={{
                            color: 'rgba(255,255,255,0.85)', fontSize: '15px',
                            lineHeight: '1.7', marginBottom: '16px', maxWidth: '280px',
                        }}
                    >
                        {t('pixDesc')}
                    </p>
